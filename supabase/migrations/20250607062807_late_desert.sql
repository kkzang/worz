/*
  ...
  1. Data Cleanup
    - Remove all programmatically generated words with patterns like _0001, _0002, etc.
    - Clean up problematic words like "measurementor", "pathwayiz"
    - Remove associated translations, relationships, and trending data

  2. Curated Word Generation
    - Insert 300 high-quality English words across 6 categories
    - Each word has accurate Korean and Japanese translations
    - Create meaningful relationships between related words
