/*
  # Clean up generated words and populate with curated vocabulary

  1. Data Cleanup
    - Remove all programmatically generated words with patterns like '_[0-9]{4}$'
    - Remove problematic words with patterns like 'measurementor' and 'pathwayiz'
    - Clean up related translations, relationships, and trends

  2. Curated Word Population
    - Add 300 carefully curated English words across 6 categories
    - Include accurate Korean and Japanese translations
    - Create meaningful word relationships
...
BEGIN
  ...
  FOR i IN 1..array_length(tech_words, 1) LOOP
    ...
    VALUES (current_word_id, 'ko', tech_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    -- Insert Japanese translation
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', tech_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
  ...
  FOR i IN 1..array_length(science_words, 1) LOOP
    ...
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ko', science_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', science_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
  ...
  FOR i IN 1..array_length(business_words, 1) LOOP
    ...
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ko', business_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', business_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
  ...
  FOR i IN 1..array_length(education_words, 1) LOOP
    ...
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ko', education_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', education_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
  ...
  FOR i IN 1..array_length(health_words, 1) LOOP
    ...
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ko', health_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', health_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
  ...
  FOR i IN 1..array_length(general_words, 1) LOOP
    ...
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ko', general_korean[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
    
    INSERT INTO word_translations (word_id, language, translation, contributor_id)
    VALUES (current_word_id, 'ja', general_japanese[i], NULL::uuid)
    ON CONFLICT (word_id, language) DO UPDATE SET
      translation = EXCLUDED.translation;
